...
class cust1 extends JFrame implements ActionListener
{
...
class cust5 extends cust1
{
  ...
  cust5()
  {
    ...
    setLayout(null);
        ...
        l1.setFont(new Font("Serif",Font.BOLD,30));
        l1.setForeground(Color.RED);
        l1.setBounds(20,30,500,40);
        add(l1);

        Label l9=new Label("Customer id",Label.LEFT);
        l9.setFont(new Font("Serif",Font.BOLD,20));
        l9.setForeground(Color.RED);
        l9.setBounds(135,100,145,30);
        add(l9);


        tf4=new JTextField();
        tf4.setBounds(340,100,200,30);
        add(tf4);
   ...
   {   FileReader tempFileReader = null;
     ...
     public void actionPerformed(ActionEvent ae)
       {  
          ...
          int id=Integer.parseInt(tff1.getText());
          if(ae.getSource()==mi1)
              {
